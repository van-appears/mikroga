...
function Level1:new()
    ...
    self.launch = {
        ...
        { 10.6, SPREADER, WHITE, STRAFE_LEFT, 100, 140 },
        { 11.3, SPREADER, WHITE, STRAFE_LEFT, 170, 140 },
        { 12.0, SPREADER, BLACK, STRAFE_LEFT, 240, 140 },
        { 12.7, SPREADER, BLACK, STRAFE_LEFT, 310, 140 },
